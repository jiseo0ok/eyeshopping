...
public class DetailActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(GG.getGuserID().equals(c1)||GG.getGGrade().equals("Admin")){
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(DetailActivity2.this, DetailWrite.class);
...
//        mapView.addPOIItem(marker);
    ...
    class BackgroundTask7 extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute() {
            target = "http://182.31.216.12:1234/tlqkf2.php?shopName="+c;
        }
        ...
        public void onPostExecute(String result){
            ...
            try {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(DetailActivity2.this,3));
...
//                item=();
        ...
        class BackgroundTask6 extends AsyncTask<Void, Void, String>
        {
            ...
            @Override
            protected void onPreExecute() {
                target = "http://182.31.216.12:1234/tlqkf.php?shopName="+c;
            }
...
//                item=();
            ...
            Glide.with(DetailActivity2.this).load("http://182.31.216.12:1234/img/"+shopUrl).into(photo1);
