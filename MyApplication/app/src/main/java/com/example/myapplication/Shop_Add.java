...
public class Shop_Add extends AppCompatActivity {
    private EditText shopId, shopName, shopAddress, shopHash,shopContext,shopCall;
    private String shopId1, shopName1, shopAddress1, shopHash1,shopUrl1,shopContext1,shopCall1;
    private ImageView image;
    private ImageButton addd, imagebt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopHash = (EditText) findViewById(R.id.shopHash);
        imagebt = (ImageButton) findViewById(R.id.imagebt);
        shopContext = (EditText) findViewById(R.id.shopContext);
        shopCall = (EditText) findViewById(R.id.shopCall);
        ...
        imagebt.setOnClickListener(view -> {
            ...
            Dexter.withActivity(Shop_Add.this)
        ...
        addd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shopId1 = shopId.getText().toString();
                shopName1 = shopName.getText().toString();
               shopAddress1 = shopAddress.getText().toString();
               shopHash1 = shopHash.getText().toString();
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(success){ // 회원가입이 가능한다면
                                Toast.makeText(getApplicationContext(), "가게등록 완료되었습니다.", Toast.LENGTH_SHORT).show();

                                Intent intent = new Intent(Shop_Add.this, Shop.class );
                                startActivity(intent);
                                finish();//액티비티를 종료시킴(회원등록 창을 닫음)

                            }else{// 회원가입이 안된다면
                                Toast.makeText(getApplicationContext(), "가게등록에 실패했습니다. 다시 한 번 확인해 주세요.", Toast.LENGTH_SHORT).show();
                                return;
                            }
                ...
                RegisterShopRequest registerRequest = new RegisterShopRequest(shopId1, shopName1, shopAddress1, shopHash1,shopUrl1,shopContext1, shopCall1,responseListener);
                RequestQueue queue = Volley.newRequestQueue(Shop_Add.this);
