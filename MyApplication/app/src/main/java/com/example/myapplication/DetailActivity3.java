...
public class DetailActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(DetailActivity3.this, DetailWrite.class);
...
//        mapView.addPOIItem(marker);
    ...
    class BackgroundTask7 extends AsyncTask<Void, Void, String>
    {
        ...
        protected void onPreExecute() {
            target = "http://182.31.216.12:1234/tlqkf3.php?userID="+c;
        }
        ...
        public void onPostExecute(String result){
            ...
            try {
                ...
                recyclerView.setLayoutManager(new GridLayoutManager(DetailActivity3.this,3));
...
//                item=();
        ...
        class BackgroundTask6 extends AsyncTask<Void, Void, String>
        {
            ...
            @Override
            protected void onPreExecute() {
                target = "http://182.31.216.12:1234/tlqkf4.php?shopId="+c;
            }
...
//                item=();
            ...
            Glide.with(DetailActivity3.this).load("http://182.31.216.12:1234/img/"+shopUrl).into(photo1);
