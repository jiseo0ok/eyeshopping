...
public class Adapter31 extends RecyclerView.Adapter<Adapter3ViewHolder1>  {
    ...
    @NonNull
    @Override
    public Adapter3ViewHolder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.shoplist, parent, false);

        Adapter3ViewHolder1 viewholder = new Adapter3ViewHolder1(context, view);

        return viewholder;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter3ViewHolder1 holder, int position) {
