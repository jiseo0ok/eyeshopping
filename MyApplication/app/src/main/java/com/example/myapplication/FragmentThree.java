...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ft.add(R.id.child_fragment, new ChildFragment31());
        ft.commit();
        //getFragmentManager().beginTransaction().add(R.id.child_fragment, new ChildFragment31()).commit();
        ...
        subButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ft.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_right, R.anim.enter_from_right, R.anim.exit_to_right);
                ft.addToBackStack(null);
                ft.replace(R.id.child_fragment, new ChildFragment31());

                ft.commit();
               // getFragmentManager().beginTransaction().replace(R.id.child_fragment, new ChildFragment31()).commit();
        ...
        subButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ft.setCustomAnimations(R.anim.enter_from_right, R.anim.exit_to_right, R.anim.enter_from_right, R.anim.exit_to_right);
                ft.addToBackStack(null);
                ft.replace(R.id.child_fragment, new ChildFragment32());

                ft.commit();
                //getFragmentManager().beginTransaction().replace(R.id.child_fragment, new ChildFragment32()).commit();
             //   ((Activity) ct).overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
